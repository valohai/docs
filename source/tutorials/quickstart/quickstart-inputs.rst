...
.. admonition:: A short recap on inputs
    ...
    * You can interpolate parameter values into input URIs with the syntax ``s3://mybucket/images/{parameter:myparam}/**.jpeggi``. This is of particular use in tasks, where you can now easily run your execution on multiple variable datasets. 

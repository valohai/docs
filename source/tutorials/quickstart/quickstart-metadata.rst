...
.. code-block:: python
    :emphasize-lines: 2,5,6,7,8,9,48,49
    :linenos:
    ...
    with numpy.load(valohai.inputs('mnist').path(), allow_pickle=True) as f:
    ...
    # Create a callback function to trigger logMetadata on each epoch end

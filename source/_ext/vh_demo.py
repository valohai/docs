...
class VHDemo(Directive):
    ...
    def run(self):
        ...
        if 'title' in options :
            ...
            titleRowContainer += nodes.raw(text='<h2 style="margin-bottom:5px;">{0}</h2>'.format(options['title']), format='html')
        ...
        headerRowContainer += nodes.raw(text='<div style="padding: 25px 0;"> \
